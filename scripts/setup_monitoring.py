...
def main():
    ...
    print(f"\n📈 View Logs:")
    print(f"   https://console.cloud.google.com/logs/query?project={PROJECT_ID}&query=resource.type%3D%22cloud_run_revision%22%0Aresource.labels.service_name%3D%22{SERVICE_NAME}%22")
